<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SecurityAdmin.aspx.cs" Inherits="TeamAssignment.Security.SecurityAdmin" %>
...
<div class="row">
    <div class="col-md-9">
        ...
        <asp:ListView ID="UsersListView" runat="server"
            ...
            ItemType="TeamAssignment.Models.ApplicationUser">
            <EditItemTemplate>
                <tr style="">
                    ...
                    <tr runat="server">
                        <td runat="server" style="">
                           <%-- <asp:DataPager runat="server" ID="DataPager1">
                            ...
                            <asp:DataPager runat="server" ID="DataPager1" PageSize="5" PagedControlID="UsersListView">
                                <Fields>
...
<asp:ObjectDataSource ID="UsersDataSource" runat="server"
    DataObjectTypeName="TeamAssignment.Models.ApplicationUser"
    DeleteMethod="DeleteUser"
    InsertMethod="AddUser"
    OldValuesParameterFormatString="original_{0}"
    SelectMethod="ListUsers"
    TypeName="TeamAssignment.Security.SecurityController"
...
<asp:ObjectDataSource ID="EmployeeListODS" runat="server" 
    ...
    TypeName="eRaceSystem.BLL.EmployeeController"
